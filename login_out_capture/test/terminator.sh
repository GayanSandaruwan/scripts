...
pid_file_path="/home/gayan/Desktop/CiperLabs/fiever/scripts/login_out_capture/test/pid"

#User login logged out acitivity will be logged to here
user_activity_log_file_path="/home/gayan/Desktop/CiperLabs/fiever/scripts/login_out_capture/test/log.txt"

#Reading the pid from file
pid=$(<"${pid_file_path}")
echo "Terminating the process $pid"
